...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            git::diagnose_git_authentication,
            ...
            auth::update_profile,
            auth::delete_profile,
            auth::assign_repository_profile,
            auth::clear_repository_profile,
            auth::get_repository_profile_assignment,
            auth::check_profile_tokens,
            auth::get_resolved_profile,
